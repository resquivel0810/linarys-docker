<?php
/*
Template Name: Search Page Blog POST
*/
?>
<!DOCTYPE html>
...
<link rel="stylesheet" href="<?php echo RUTATEMA; ?>/css/style_blog_cate.css">
            <?php
              $post_home = new WP_Query( array(
              'post_type' => 'post',
              'category_name'  => 'Search-blog',
              'posts_per_page' => '1',
              'order' => 'DESC',
            ) );
            $i=0;
            ...
            <?php
            $more= get_field('see_more');
            $back = get_field('back_button');
            $related = get_field('related_news');
            $results = get_field('no_results');
            ?>
            <?php endwhile; endif; ?>
    <!-- HEADER -->
    <section>
        ...
        <div class="container relative">
          ...
          <div class="box_search">
            <form method="get" id="searchform" action="<?php echo esc_url( home_url( '/post-search/' ) ); ?>">
              <input type="text" class="form_input_1" name="x" id="x" placeholder="<?php echo $s; ?>" />
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6 col-md-6">
                <div class="container_cate">
                  ...
                  <?php echo '<a href="' . get_permalink($recent["ID"]) . '" class="link_1 ">'.$more.'></a>'; ?>
                </div>
              </div>
              <?php endwhile; ?>
              ...
              <?php else: ?>
                ...
                <div class="col-12">
                  ...
                  <div class="centerText">
                    <a href="https://preview.linarys.com/blog/" class="linkBack "> < <?php echo $back; ?></a>
                  </div>
                </div>
              <?php endif; ?>
            </div>
    ...
    <section>
      <div class="bg_carrousel">
        <div class="container relative centerPosition">
          <h2 class="centerText"><?php echo $related; ?></h2>
